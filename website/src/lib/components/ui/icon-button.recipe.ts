...
export const iconButtonRecipe = tv({
  ...
  variants: {
    variant: {
      outline:
        'border border-neutral-200 bg-white dark:bg-transparent dark:border-neutral-700 ui-pressed:bg-neutral-100/75 ui-on:bg-neutral-100/75 dark:ui-pressed:bg-neutral-700/25 dark:ui-on:bg-neutral-700/25',
