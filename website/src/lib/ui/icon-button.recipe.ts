...
export const iconButtonRecipe = tv({
  ...
  variants: {
    variant: {
      outline:
        'border border-neutral-200 bg-white dark:bg-transparent dark:border-neutral-700 aria-pressed:bg-neutral-100/75 dark:aria-pressed:bg-neutral-700/25 aria-page:border-indigo-500 aria-page:bg-indigo-500/15 aria-page:text-indigo-200',
