  ...
  >
    ...
    <Portal>
      <HoverCard.Positioner>
        <HoverCard.Content
          class="w-[90vw] rounded border border-neutral-200 bg-white p-4 data-open:animate-fade-in data-closed:animate-fade-out dark:border-neutral-800 dark:bg-neutral-900 lg:max-w-[24rem]"
        >
          <HoverCard.Arrow
          ...
          natus neque, tenetur praesentium laboriosam esse eius at maxime quam
          magni rerum animi ducimus debitis?
        </HoverCard.Content>
      </HoverCard.Positioner>
    </Portal>
  </HoverCard.Root>
